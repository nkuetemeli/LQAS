...
if __name__ == '__main__':
    ...
    filename = f'ModelsFL'+str(params.frozen_linear)+'/vanillaCNN_' + params.which_model_net + '.sav'

    # # Train and save the model
    # model = train(params, filename, classes, train_loader, val_loader, test_loader)
